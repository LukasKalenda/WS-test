...
const API_KEY_NJ =
  "zkqqUnm4u1I6RM22Klkf731Y668SWVkry1RrU5q8i2i32lcdlcEx4Tr9r7txCjud";

const ECOMAIL_API_KEY =
  "1a01940cbe7689a1725cc0f5f4d3cb02eb5509e8acba75f7cd0e9d411cf1a912";
const ECOMAIL_LIST_ID = "test";

async function createOrGetClient(clientData) {
  try {
    const searchResponse = await fetch(
      `${API_BASE_URL}/clients?email=${clientData.email}`,
      {
        headers: {
